											...
											<table class="table table-striped table-bordered table-hover" id="datatable_products">
												<thead>
													...
													<tr role="row" class="filter">
														<?php echo form_open('auth/search_tags')?>
															<td>
															</td>
															<td>
															</td>
														...
														foreach ($tags as $tag) {
															?>
																<tr>
																	...
																	<td>
																		<span >
				                                                            <a href="<?php echo base_url('vendor/tag/edit/'. $tag->slug)?>" class="label label-sm label-warning"><i class="fa fa-edit"></i> Edit</a>
				                                                        </span>
				                                                        <span >
					                                                        <a href="<?php echo base_url('vendor/tag/'.$tag->slug)?>" class="label label-sm label-info"><i class="fa fa-search"></i> View</a>
					                                                    </span>
																	</td>
																</tr>
															<?php
