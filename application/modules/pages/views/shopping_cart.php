    ...
    <div class="main">
      <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active"><?php echo $this->lang->line('shopping_cart_heading')?></li>
        </ul>
        ...
        <div class="row margin-bottom-40">
          ...
          <?php 
            if (!empty($cart_items)) {
                ...
                <div class="col-md-12 col-sm-12">
                  <div class="goods-page">
                        ...
                        <?php foreach($cart_items as $cart_item):?>
                          <tr>
                            <td class="del-goods-col">
                              <?php echo anchor('pages/remove/'.$cart_item['rowid'], 'X')?>
                            </td>
                            <td class="goods-page-image">
                              <a href="javascript:;"><img src="<?php echo base_url()?>public/attachments/products/<?php echo $cart_item['image']?>" alt="<?php echo $cart_item['name']?>"></a>
                            </td>
                            <td class="goods-page-description">
                              <h3><a href="<?php echo base_url($cart_item['slug'])?>"><?php echo $cart_item['name']?></a></h3>
                            ...
                            <td class="goods-page-price">
                              <strong><span><?php echo $store_currency?> </span><?php echo number_format($cart_item['price'], 2)?></strong>
                            </td>
                            <td class="goods-page-total">
                              <strong><span><?php echo $store_currency?> </span><?php echo number_format($cart_item['subtotal'], 2)?></span></strong>
                            </td>
                      ...
                      <div class="shopping-total">
                        <ul>
                          <li class="shopping-total-price">
                            <em>Total</em>
                            <strong class="price"><span><?php echo $store_currency?> </span><?php echo number_format($this->cart->total(),2)?>
                            </strong>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url()?>pages/clearcart" class="btn btn-danger ">Clear Cart</a>
                      <a href="<?php echo base_url()?>checkout" class="btn btn-primary ">Checkout <i class="fa fa-check"></i></a>
                    </div>
                  </div>
                </div>
              <?php
              ...
              ?>
                <div class="col-md-12 col-sm-12">
                  <h1><?php echo $this->lang->line('shopping_cart_heading')?></h1>
