            ...
            if (!$this->ion_auth->logged_in()) {
              ...
              <div class="sidebar col-md-3 col-sm-3">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                  ...
                  <li class="list-group-item clearfix active"><a href="<?php echo base_url()?>reset_password"><i class="fa fa-angle-right"></i> Reset Password</a></li>
              ...
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <form class="form-horizontal" action="<?php echo base_url()?>my-account/reset-password" method="post">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <label for="password_confirm" class="col-lg-4 control-label">Password Confirm<span class="require">*</span></label>
                        <div class="col-lg-8">
                ...
                <div class="col-md-4 col-sm-4 pull-right">
                  <div class="form-info">
                    ...
                    <p><?php echo $this->lang->line('reset_password_heading')?></p>
