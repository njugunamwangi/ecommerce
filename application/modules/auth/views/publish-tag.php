		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Add Tag <small>add product tag</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
                		...
                		<div class="row">
                            <div class="col-md-12">
                                <div class="portlet box ">
                                    ...
                                    <!-- BEGIN FORM-->
                                        <form method="post">
                                            <?php echo form_open('admin/products/tags/add'); ?>
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="tag" style="text-transform: capitalize;" class="form-control" placeholder="Tecno" value="" id="tag"> 
                                                    </div>
