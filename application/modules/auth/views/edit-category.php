	<title><?php echo 'Edit ', $title, ' | ', $name_of_store?></title>
</head>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo base_url()?>admin/products/categories"><?php echo lang('list_categories_heading')?></a>
					<i class="fa fa-circle"></i>
				</li>
				<li class="active">
					<?php echo 'Edit ', $title ?>
							...
							<?php echo form_open('admin/category/edit/'.$category->id); ?>
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="category" style="text-transform: capitalize;" class="form-control" placeholder="Household" value="<?php echo $category->category?>" id="category"> 
                                        </div>
                                ...
                                <div class="form-actions">
                                    <div class="btn-set pull-right">
                                        ...
                                        <button type="submit" class="btn blue"><i class="fa fa-check-square-o"></i>Update Category</button>
                                    </div>
                                </div>
                            <?php echo form_close()?>
