		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li>
						<span class="active"> <?php echo lang('user_profile_heading'); ?></span>
					</li>
				</ul>
				<!-- END PAGE BREADCRUMB -->
				<!-- END PAGE HEADER-->
					...
					<div class="col-md-12">
						...
						<div class="profile-sidebar" style="width: 250px;">
							...
							<div class="portlet light profile-sidebar-portlet">
								...
								<div class="profile-usertitle">
									<div class="profile-usertitle-name">
										 <?php echo $user_account->first_name;?> <?php echo $user_account->last_name;?>
									</div>
									<div class="profile-usertitle-job">
										 <?php echo $user_account->company?>
									</div>
								</div>
							...
							<div class="portlet light">
								...
								<!-- END STAT -->
								<div>
									<h4 class="profile-desc-title">About <?php echo $user_account->first_name?></h4>
									<span class="profile-desc-text"> Lorem ipsum dolor sit amet diam nonummy nibh dolore. </span>
									<div class="margin-top-20 profile-desc-link">
										<i class="fa fa-envelope"></i>
										<a href="mailto:<?php echo $user_account->email?>"><?php echo $user_account->email?></a>
									</div>
									<div class="margin-top-20 profile-desc-link">
										<i class="fa fa-phone"></i>
										<?php echo $user_account->phone?></a>
									</div>
									<div class="margin-top-20 profile-desc-link">
										...
										<div class="portlet-body">
											<div class="tab-content">
												...
												<div class="tab-pane active" id="tab_1_1">
													<form role="form" action="#">
														<div class="form-group">
															...
															<input type="text" placeholder="John" value="<?php echo $user_account->first_name?>" class="form-control"/>
														</div>
														<div class="form-group">
															<label class="control-label">Last Name</label>
															<input type="text" placeholder="Doe" value="<?php echo $user_account->last_name?>" class="form-control"/>
														</div>
														<div class="form-group">
															<label class="control-label">Mobile Number</label>
															<input type="text" placeholder="+1 646 580 DEMO (6284)" value="<?php echo $user_account->phone?>" class="form-control"/>
														</div>
														<div class="form-group">
												...
												<div class="tab-pane" id="profile_picture">
													...
													<form method="post" action="<?php echo base_url('auth/upload_profile_picture')?>" enctype="multipart/form-data">
														<div class="form-group">
