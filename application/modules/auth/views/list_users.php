												...
												<td>
                                                    <span >
                                                    	<?php
                                                    		{
                                                    			?>
                                                    				<a href="<?php echo base_url('admin/users/edit/'. $user->id)?>" class="label label-sm label-info"><i class="fa fa-edit"></i> <?php echo lang('edit_user')?></a>
                                                    			<?php
                                                    		}
                                                    	?>
                                                    ...
                                                    <?php
                                                        if ($user->active) {
                                                            ?>
                                                            <span >
                                                                <a href="<?php echo base_url('admin/users/deactivate/'. $user->id)?>" class="label label-sm label-warning"><i class="fa fa-times"></i> <?php echo lang('deactivate_an_active_user')?></a>
                                                            </span> 
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <span >
                                                                <a href="<?php echo base_url('admin/users/activate/'. $user->id)?>" class="label label-sm label-success"><i class="fa fa-check"></i> <?php echo lang('activate_a_suspended_user')?></a>
                                                            </span>
                                                    ...
                                                    ?>
                                                    <span >
                                                        <a href="<?php echo base_url('admin/users/delete/'.$user->id)?>" class="label label-sm label-danger"><i class="fa fa-trash-o"></i> Delete</a>
                                                    </span><br />
                                                    ...
                                                    <?php
                                                        if ($group->name === 'vendor') {
                                                            ?>
                                                            <span >
                                                                <a href="<?php echo prep_url($user->slug.'.ecommerce.com/dashboard')?>" class="label label-sm label-default"><i class="fa fa-user-secret"></i> <?php echo lang('login_as_an_admin')?></a>
                                                            </span> 
                                                            <?php
