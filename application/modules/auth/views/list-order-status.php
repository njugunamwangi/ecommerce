	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					<?php echo lang('list_order_status_heading') ?>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
            	...
            	if (empty($order_statuses)) {
            		?>
	            		<div class="alert alert-danger">
	                        <div id="infoMessage"> No <?php echo strtolower(lang('list_order_status_heading')) ?> added yet</div>
	                    </div>
                    <?php
            	} else {
            		?>
								...
								<div class="portlet light">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-green-sharp bold uppercase"><?php echo lang('list_order_status_heading') ?></span>
											<span class="caption-helper">manage <?php echo strtolower(lang('list_order_status_heading')) ?>...</span>
										</div>
										<div class="actions">
											<div class="btn-group">
											...
											<table class="table table-striped table-bordered table-hover" id="datatable_products">
												<thead>
													...
													<tr role="row" class="filter">
														<?php echo form_open('auth/search_order_statuses')?>
															<td>
															</td>
															<td>
															</td>
																...
																<select name="status" class="form-control select2me form-filter input-sm">
																	...
																	<?php
																		foreach ($order_statuses as $order_status) {
																			?>
																				<option value="<?php echo $order_status->id ?>"><?php echo $order_status->status ?></option>
																			<?php
																		}
																	?>
																</select>
														...
														foreach ($order_statuses as $order_status) {
															?>
																<tr>
														            ...
														            <td>
														            	<?php echo $order_status->status ?>
														            </td>
														            <td>
														            	<span class="<?php echo $order_status->badge ?>">
														            		<?php echo $order_status->status ?>
														            	</span>
														            </td>
																	<td>
																		<span >
				                                                            <a href="<?php echo base_url('admin/order_status/edit/'. $order_status->id)?>" class="label label-sm label-warning"><i class="fa fa-edit"></i> Edit</a>
				                                                        </span>
				                                                        <span >
					                                                        <a href="<?php echo base_url('admin/order_status/'.$order_status->id)?>" class="label label-sm label-info"><i class="fa fa-search"></i> View</a>
					                                                    </span>
					                                                    <span >
					                                                        <a href="<?php echo base_url('admin/order_status/delete/'.$order_status->id)?>" class="label label-sm label-danger"><i class="fa fa-times"></i> Delete</a>
					                                                    </span>
																	</td>
																</tr>
															<?php
