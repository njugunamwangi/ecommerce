	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					<?php echo $this->lang->line('publish_subcategory_heading')?>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-body form">
							<?php echo form_open('auth/publish_subcategory')?>
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="control-label" for="subcategory">Sub Category <span class="required"> *</span></label>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="fa fa-paragraph"></i>
                                            </span>
                                            <input type="text" name="subcategory" style="text-transform: capitalize;" class="form-control" placeholder="Basins, Buckets..." value="" id="subcategory"> 
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="category" class="form-control select2me" name="category" >
                                ...
                                <div class="form-actions">
                                    <div class="btn-set pull-right">
                                        ...
                                        <button type="submit" class="btn blue"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('publish_subcategory_heading')?></button>
                                    </div>
                                </div>
                            <?php echo form_close()?>
