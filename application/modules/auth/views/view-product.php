																					...
																					<td>
																						<?php
																							if ($product_review->status == 0) {
																								?>
																									<span >
											                                                            <a href="<?php echo base_url('admin/product_review/approve/'. $product_review->id)?>" class="label label-sm label-success"><i class="fa fa-check"></i> Approve</a>
											                                                        </span>
											                                                        <span >
											                                                            <a href="<?php echo base_url('admin/product_review/reject/'. $product_review->id)?>" class="label label-sm label-danger"><i class="fa fa-times"></i> Reject</a>
											                                                        </span>
																								<?php
																							} elseif ($product_review->status == 1) {
																								?>
