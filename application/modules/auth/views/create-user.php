    ...
    <div class="page-content">
      ...
      <div class="page-head">
        ...
        <div class="page-title">
          <h1><?php echo $this->lang->line('users')?> <small><?php echo $this->lang->line('create_user_heading')?></small></h1>
        </div>
        <!-- END PAGE TITLE -->
        <!-- BEGIN PAGE TOOLBAR -->
      ...
      <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
          <a href="<?php echo base_url()?>admin/users"><?php echo $this->lang->line('users')?></a>
          <i class="fa fa-circle"></i>
        </li>
        <li class="active">
          <a><?php echo $this->lang->line('create_user_heading')?></a>
        </li>
      </ul>
      <!-- END PAGE BREADCRUMB -->
      <!-- END PAGE HEADER-->
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="first_name"  style="text-transform: capitalize;" class="form-control" placeholder="First Name" value="" id="first_name"> 
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="last_name" style="text-transform: capitalize;" name="last_name" class="form-control" placeholder="Last Name" value=""> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="company" style="text-transform: capitalize;" class="form-control" placeholder="Company Name" value=""> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="email" name="email"class="form-control" placeholder="Email Address" id="email" value=""> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password" name="password_confirm" class="form-control" placeholder="Confirm Password" value=""> 
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-actions">
                                                    <div class="btn-set pull-right">
                                                        ...
                                                        <button type="submit" class="btn blue"><i class="fa fa-check"></i> Create User</button>
                                                    </div>
                                                </div>
                                            </form>
                                            <!-- END FORM-->
