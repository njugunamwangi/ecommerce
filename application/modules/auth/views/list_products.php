												...
												<tbody>
													<?php foreach ($products as $product):?>
														<tr>
		                                                    ...
		                                                    <td>
		                                                        <?php echo htmlspecialchars($product->sale_price,ENT_QUOTES,'UTF-8');?>
		                                                    </td>
															<td>
															...
															<td>
																<span >
		                                                            <a href="<?php echo base_url('admin/product/edit/'. $product->slug)?>" class="label label-sm label-danger"><i class="fa fa-edit"></i> Edit</a>
		                                                        </span>
															</td>
														</tr>
													<?php endforeach;?>
